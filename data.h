...
char *ERRORS[] = {
    ...
    /*33*/ "THE CONSUMER ACCOUNT DOES NOT SEEM TO BE UNDER THE SYSTEM ACCOUNT ANYMORE",
    /*34*/ "SERVICE IS NOLONGER ACTIVE",
    /*35*/ "ACCOUNT ALREADY SUBSCRIBED TO THIS SERVICE",
    /*36*/ "SYSTEM ONLY DEALS WITH POSITIVE VALUES",
};
